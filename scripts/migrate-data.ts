...
const OLD_DB_PATH = join(PROJECT_ROOT, "previous", "recipes.db");
const OLD_PHOTOS_DIR = join(PROJECT_ROOT, "previous", "photos");
const NEW_DB_PATH = join(PROJECT_ROOT, "data", "dev", "kitchen.db");
const NEW_PHOTOS_DIR = join(PROJECT_ROOT, "data", "dev", "photos");
